...
function levels.level5.load()
	require 'libs/Level'
	require 'libs/Map'
	require 'libs/Movable'
	require 'libs/Image'
	require 'libs/Behaviour'
	level = levelLib.new(50,{},mapLib.new ({'level5',ts=50}, imageLib.standartMapImages, mapLib.standartProbability, 13,13, 0, 0)) --not trash yet
...
function levels.level5.update(dt)
